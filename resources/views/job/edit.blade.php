...
<div class="page-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title m-b-0">Jobs Edit Form</h5>
                <br><br>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control international-inputmask" name="company" placeholder="company" value="{{ $job->company }}">
                </div>
                <div class="form-group">
                    ...
                    <select id="Job_levels" type="text" class="form-control @error('Job_levels') is-invalid @enderror"  name="Job_levels" required autocomplete="Job_levels" autofocus>
                        <?php
                        if ($job->job_levels != ""){
                            echo "<option selected = 'selected'  value='{{ $job->job_levels }}'>$job->job_levels</option>";
                        }
                    ?>
                ...
                <div class="form-group">
                    ...
                    <div class="form-control international-inputmask">
                        <select id="job_title" type="text" class="form-control international-inputmask @error('job_title') is-invalid @enderror"  name="job_title"  required autocomplete="job_title" autofocus>
                            <?php
                        if ($job->job_title != ""){
                            echo "<option selected = 'selected'  value='{{ $job->job_title }}'>$job->job_title</option>";
                        }
                    ?>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control international-inputmask" name="short_description" placeholder="short_description">{{ $job->short_description }}</textarea>
                </div>
                <div class="form-group">
                    <label>Phone </label>
                    <input type="text" class="form-control xphone-inputmask" name="phone" value="{{ $job->phone }}"placeholder="Enter Phone Number">
                </div>
                <div class="form-group">
                    <label>Skills Requirements</label>
                    <textarea type="text" class="form-control purchase-inputmask" name="skills_requirements"placeholder="briefly elucidate the skills and requirements necessary">{{ $job->skills_requirements }} </textarea>
                </div>
                <div class="form-group">
                      ...
                      <div class="form-control international-inputmask">
                            <select id="highest_qualification" type="text" class="form-control @error('highest_qualification') is-invalid @enderror" name="highest_qualification" required autocomplete="highest_qualification" autofocus>
                                ...
                                if ($job->highest_qualification != ""){
                                    echo "<option selected = 'selected'  value='{{ $job->highest_qualification }}'>$job->highest_qualification</option>";
                                }
                            ?>
           ...
           <div class="form-group ">
            ...
            <div class="form-control international-inputmask">
                    <select id="experience" type="number" class="form-control xphone-inputmask @error('firstname') is-invalid @enderror" name="experience"  required autocomplete="experience" autofocus>
                        <?php
                        if ($job->experience != ""){
                            echo "<option selected = 'selected'  value='{{ $job->experience }}'>$job->experience</option>";
                        }
                    ?>
        ...
        <div class="form-group ">
            ...
            <div class="form-control international-inputmask">
                    <select id="salary" type="text" class="form-control international-inputmask @error('salary_range') is-invalid @enderror" name="salary"    required autocomplete="salary" autofocus>
                        <?php
                        if ($job->salary != ""){
                            echo "<option selected = 'selected'  value='{{ $job->salary }}'>$job->salary</option>";
                        }
                    ?>
        ...
        <div class="form-group ">
            ...
            <div class="form-control international-inputmask">
                <select id="posted" type="text" class="form-control international-inputmask @error('posted') is-invalid @enderror" name="posted"  required autocomplete="posted" autofocus>
                    <?php
                    if ($job->posted != ""){
                        echo "<option selected = 'selected'  value='{{ $job->posted }}'>$job->posted</option>";
                    }
                ?>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control international-inputmask" name="city"  value="{{ $job->city}}"  placeholder="city">
        </div>
