                    ...
                    <form action="{{ route('employee.update',$employee->id) }}" method="POST">
                        ...
                        <fieldset>
                            <div class="section express-yourself">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="fullname" value="{{ $employee->fullname }}" class="form-control" placeholder="ex Jhon Doe">
                                    </div>
                                </div>
                                <div class="row form-group additional-information">
                                    <label class="col-md-4 label-title">Address</label>
                                    <div class="col-md-8">
                                        <textarea class="form-control" type="text"  name="address">{{ $employee->address }}</textarea>
                                    </div>
                                </div>
                            ...
                            <div class="section career-objective">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" type="text"  name="objective" placeholder="Write few lines about your career objective" rows="8">{{ $employee->objective }}</textarea>		
                                </div>
                            ...
                            <div class="row form-group time-period">
                               <label class="col-md-3 label-title">Date of Birth</label>
                                <div class="col-md-8">
                                    <input type="date" name="date" class="form-control"  value="{{ $employee->date }}" placeholder="dd/mm/yy"><span>
                            ...
                            <div class="section">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="companyworked" value="{{ $employee->companyworked }}" class="form-control" placeholder="Name">
                                    </div>
                                </div>
                                <div class="row form-group">
                         ...
                         <select class="col-md-9" name="designation" type="text"style="height:50px; border-radius:10px">
                            ...
                            if ($employee->designation != ""){
                                echo "<option selected = 'selected'  value='{{ $employee->designation }}'>$employee->designation</option>";
                            }
                        ?>
                        ...
                        <option value="Other">Other</option>
                                ...
                                <div class="row form-group job-description">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" placeholder="" type="text"  name="aboutyou"  rows="8">{{ $employee->aboutyou }}</textarea>		
                                    </div>
                                </div>
                            ...
                            <div class="section education-background">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="institutename" value="{{ $employee->institutename }}" class="form-control" placeholder="ropbox">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="col-md-9" name="highest_qualification" type="text" style="height:50px; border-radius:10px">
                                            ...
                                            if ($employee->highest_qualification != ""){
                                                echo "<option selected = 'selected'  value='{{ $employee->highest_qualification }}'>$employee->highest_qualification</option>";
                                            }
                                        ?>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="Language"value="{{ $employee->Language }}" class="form-control" placeholder="English">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="rating-star">
                                            <div class="rating">
                                                <?php
                                                if ( $employee->ratig != ""){
                                                    echo "<option selected = 'selected'  value='{{ $employee->ratig}}'> $employee->ratig</option>";
                                                }
                                            ?>
                                                <input type="radio" id="star1"value="" name="rating"><label class="full" for="star1"></label>
                                                ...
                                                <input type="radio" id="star10" name="rating" value=""><label class="half" for="star10"></label>
                                            </div>
                                        </div><!-- rating-star -->
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="col-md-9" name="city" type="text" style="height:50px; border-radius:10px">
                                            <?php
                                            if ($employee->city != ""){
                                                echo "<option selected = 'selected'  value='{{  $employee->city }}'>$employee->city</option>";
                                            }
                                        ?>
